...
<!--num:latency_p50_round-->250 ms<!--/num--> for about a thousandth of a cent.
...
| per line | ~<!--num:latency_p50_round-->250 ms<!--/num-->, ~<!--num:dollars_per_call-->$0.000013<!--/num--> (measured below) | a round trip plus generated tokens, <!--num:cost_ratio_range-->19.3-257.9x the cost<!--/num--> | fast after indexing; needs an index |
...
<p align="center"><img src="docs/assets/throughput.svg" alt="lines judged per second" width="760"></p>
...
- **Latency:** 251 ms median per decision end to end (p95 331 ms), measured through vercel; asking 16 questions about the same line costs about the same time as one.
