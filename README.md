...
- **vs chat models:** the same yes/no decision costs 3.8x to 130.9x more at list price (gpt-5.6-luna, gpt-5.4-mini, gemini-3.8-flash, …), before counting their 4-5x higher latency.
