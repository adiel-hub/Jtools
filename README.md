...
| per line | ~<!--num:latency_p50_round-->240 ms<!--/num-->, ~<!--num:dollars_per_call-->$0.000013<!--/num--> (measured below) | a round trip plus generated tokens, <!--num:cost_ratio_range-->19.3-257.9x the cost<!--/num--> | fast after indexing; needs an index |
